...
public class RegisterController {
	...
	*/
	/* 요청 파라미터 접근 방식1*/
	/*
	 * @PostMapping("/register/step2") public String handleStep2(HttpServletRequest
	 * request) { String agreeParam = request.getParameter("agree");
	 * 
	 * 
	 * if (agreeParam == null || !agreeParam.equals("true")){ return
	 * "register/step1"; }
	 * 
	 * return "register/step2"; }
	 */	
